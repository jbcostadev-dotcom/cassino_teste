                ...
                return $builder->groups([
                    ...
                    NavigationGroup::make('GESTÃO DA PLATAFORMA')
                        ->items([
                            ...
                            ->icon('heroicon-o-cpu-chip')
                            ->label(fn (): string => 'HISTORICO FREEBETS')
                    ...
                    NavigationGroup::make('JOGOS DA PLATAFORMA')
                        ...
                        NavigationGroup::make('SISTEMA')
                                                ->items([
                                                    // ⬇️ NOVO ITEM: abre a página Filament com os botões
                                                    NavigationItem::make('Limpeza de Cache')
                                                        ->icon('heroicon-o-cog-8-tooth')
                                                        ->label(fn (): string => 'LIMPEZA DE CACHE')
                                                        ->url(fn (): string => SystemTools::getUrl())
                                                        ->isActiveWhen(fn () => request()->routeIs('filament.pages.system-tools')),
                                                ]),
                ]);
            })
            ->middleware([
